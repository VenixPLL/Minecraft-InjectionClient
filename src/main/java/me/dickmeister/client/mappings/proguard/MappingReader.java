package me.dickmeister.client.mappings.proguard;
...
{
    private final String mappingData;


    public MappingReader(String mappingFile)
    {
        this.mappingData = mappingFile;
    }
    ...
    {
        LineNumberReader reader = new LineNumberReader(new BufferedReader(new StringReader(mappingData)));
        try
        {
